...
#meanRate = 6.11*10**(-6)
#stdev = 2*10**-6
#rates=rnorm(sample_size,meanRate,stdev)
#######
...
#mu_max is a random number taken from the Normal distribution with mean = muMax and standard deviation = muMax_stdev
muMax = 3.65*10**(-2)
muMax_stdev=5.0*10**-3
